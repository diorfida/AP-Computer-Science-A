...
public class Picture extends SimplePicture 
{
  ...
  // keepOnlyBlue - in tester class
  // keepOnlyRed - in tester class
  // keepOnlyGreen - in tester class
  // nagate - in tester class
  // grayscale - in tester class
  ...
  // mirrorVerticalRightToLeft - in tester class
  // mirrorHorizontal - in tester class
  // mirrorHorizontalBotToTop - in tester class
  ...
  // mirrorArms - in tester class
  // mirrorGull - in tester class
